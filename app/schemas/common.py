...
class DebugView(BaseModel):
    ...
    agent_turn_context: dict[str, Any] = Field(default_factory=dict)
    context_budget_report: dict[str, Any] = Field(default_factory=dict)
    intent_draft: dict[str, Any] = Field(default_factory=dict)
    ...
    multi_agent_lite: dict[str, Any] = Field(default_factory=dict)
