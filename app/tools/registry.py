...
TOOL_REGISTRY: dict[str, ToolSpec] = {
    ...
    "mcp_get_asset_details": ToolSpec(
        tool_id="mcp_get_asset_details",
        task_type="editor_operation",
        title="Get Asset Details",
        description="Read one live Content Browser asset's type, path, package, class, and basic details from the optional UEAgentTool TCP tool server.",
        side_effect_level="read_only",
        route_preference="single_tool",
        category="sensing",
        transport="mcp_tcp",
        mcp_tool_name="get_asset_details",
        requires_confirmation=False,
        active_context_keys=("project", "editor", "asset"),
        owned_by_skill="AssetMaintenanceSkill",
        allowed_in_free_chat=True,
        ...
        output_schema={
            ...
            "properties": {
                ...
                "structuredContent": {
                    "type": "object",
                    "properties": {
                        "asset_detail_schema_version": {"type": "string"},
                        "asset_name": {"type": "string"},
                        "asset_path": {"type": "string"},
                        "asset_type": {"type": "string"},
    ...
    "editor_select_level_actors": ToolSpec(
        tool_id="editor_select_level_actors",
        task_type="editor_operation",
        title="Select Level Actors",
        description="Create a confirmed editor operation proposal to select a bounded Actor set in the current level.",
        side_effect_level="confirmed_write",
        route_preference="proposal_wait",
        category="write",
        transport="http",
        ...
        permission_gate="editor_operation_proposal",
        context_cost="low",
        trigger_keywords=("select actors", "highlight actors", "focus actors", "选择Actor", "选中Actor"),
        required_payload_fields=("selection",),
        optional_payload_fields=("actor_references", "query", "class_contains", "tag", "folder_path", "max_count", "reason", "source_task_id"),
        input_schema={
            "type": "object",
            "properties": {
                "selection": {
                    "type": "object",
                    "properties": {
                        "actor_references": {"type": "array", "items": {"type": "string"}, "maxItems": 50},
                        "query": {"type": "string"},
                        "class_contains": {"type": "string"},
                        "tag": {"type": "string"},
                        "folder_path": {"type": "string"},
    ...
    "editor_set_actor_folder": ToolSpec(
        tool_id="editor_set_actor_folder",
        task_type="editor_operation",
        title="Set Actor Folder",
        description="Create a confirmed editor operation proposal to move a bounded Actor set into one World Outliner folder.",
        side_effect_level="confirmed_write",
        route_preference="proposal_wait",
        category="write",
        transport="http",
        ...
        permission_gate="editor_operation_proposal",
        context_cost="medium",
        trigger_keywords=("set actor folder", "organize actors", "move actors to folder", "world outliner folder"),
        required_payload_fields=("selection", "target_folder_path"),
        optional_payload_fields=("actor_references", "query", "class_contains", "tag", "folder_path", "max_count", "reason", "source_task_id"),
        input_schema={
            "type": "object",
            "required": ["selection", "target_folder_path"],
            "properties": {
                "selection": {
                    "type": "object",
                    "properties": {
    ...
    "editor_set_actor_tags": ToolSpec(
        tool_id="editor_set_actor_tags",
        task_type="editor_operation",
        title="Set Actor Tags",
        description="Create a confirmed editor operation proposal to replace, append, or remove tags on a bounded Actor set.",
        side_effect_level="confirmed_write",
        route_preference="proposal_wait",
        category="write",
        transport="http",
        ...
        permission_gate="editor_operation_proposal",
        context_cost="medium",
        trigger_keywords=("set actor tags", "add actor tag", "remove actor tag", "append actor tag"),
        required_payload_fields=("selection", "tags"),
        optional_payload_fields=("actor_references", "query", "class_contains", "tag", "folder_path", "max_count", "tag_mode", "reason", "source_task_id"),
        input_schema={
            "type": "object",
    ...
    "editor_set_actor_visibility": ToolSpec(
        tool_id="editor_set_actor_visibility",
        task_type="editor_operation",
        title="Set Actor Visibility",
        description="Create a confirmed editor operation proposal to set Hidden In Game on a bounded Actor set.",
        side_effect_level="confirmed_write",
        route_preference="proposal_wait",
        category="write",
        transport="http",
        ...
        permission_gate="editor_operation_proposal",
        context_cost="medium",
        trigger_keywords=("hide actors", "show actors", "actor visibility", "hidden in game"),
        required_payload_fields=("selection", "hidden_in_game"),
        optional_payload_fields=("actor_references", "query", "class_contains", "tag", "folder_path", "max_count", "reason", "source_task_id"),
        input_schema={
            "type": "object",
            "required": ["selection", "hidden_in_game"],
            "properties": {
                "selection": {
                    "type": "object",
                    "properties": {
