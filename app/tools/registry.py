...
TOOL_REGISTRY: dict[str, ToolSpec] = {
    ...
    "query_project_inventory": ToolSpec(
        ...
        input_schema={
            ...
            "properties": {
                ...
                "selected_actor_references": {"type": "array", "items": {"type": "string"}},
                "current_actor_reference": {"type": "string"},
                "selected_material_instance_paths": {"type": "array", "items": {"type": "string"}},
                "current_material_instance_path": {"type": "string"},
    ...
    "editor_inspect_assets": ToolSpec(
        tool_id="editor_inspect_assets",
        task_type="project_qa",
        title="Inspect Assets",
        description="Read asset names, types, paths, dependencies, referencers, and captured settings from Project Inventory.",
        side_effect_level="read_only",
        ...
        permission_gate="read_only_whitelist",
        context_cost="low",
        trigger_keywords=("inspect assets", "find assets", "asset list", "asset inventory"),
        required_payload_fields=(),
        optional_payload_fields=("project_id", "query", "asset_type", "limit"),
        input_schema={
            "type": "object",
            "properties": {
                "project_id": {"type": "string"},
    ...
    "editor_inspect_asset_detail": ToolSpec(
        tool_id="editor_inspect_asset_detail",
        task_type="project_qa",
        title="Inspect Asset Detail",
        description="Read one asset detail record from Project Inventory by id, path, name, or query.",
        side_effect_level="read_only",
        route_preference="workflow",
        category="sensing",
        transport="http",
        ...
        permission_gate="read_only_whitelist",
        context_cost="low",
        trigger_keywords=("asset detail", "asset info", "inspect asset detail"),
        required_payload_fields=("asset_id",),
        optional_payload_fields=("project_id", "asset_path", "query"),
        input_schema={
            "type": "object",
            "properties": {
                "project_id": {"type": "string"},
    ...
    "editor_inspect_level_actors": ToolSpec(
        tool_id="editor_inspect_level_actors",
        task_type="project_qa",
        title="Inspect Level Actors",
        description="Read level Actor labels, classes, transforms, folders, tags, and components from Project Inventory.",
        side_effect_level="read_only",
        route_preference="workflow",
        category="sensing",
        transport="http",
        requires_confirmation=False,
        active_context_keys=("project", "level", "asset"),
        owned_by_skill="ProjectQASkill",
        allowed_in_free_chat=False,
        permission_gate="read_only_whitelist",
        context_cost="low",
        trigger_keywords=("inspect level actors", "level actors", "actor inventory", "find actors"),
        required_payload_fields=(),
        optional_payload_fields=("project_id", "query", "level_name", "limit"),
        input_schema={
            "type": "object",
            "properties": {
                "project_id": {"type": "string"},
    ...
    "editor_inspect_level_actor_detail": ToolSpec(
        tool_id="editor_inspect_level_actor_detail",
        task_type="project_qa",
        title="Inspect Level Actor Detail",
        description="Read one level Actor detail record from Project Inventory by label, name, path, or query.",
        side_effect_level="read_only",
        route_preference="workflow",
        category="sensing",
        transport="http",
        ...
        permission_gate="read_only_whitelist",
        context_cost="low",
        trigger_keywords=("actor detail", "inspect actor", "level actor detail"),
        required_payload_fields=("actor_reference",),
        optional_payload_fields=("project_id", "query"),
        input_schema={
            "type": "object",
            "properties": {
                "project_id": {"type": "string"},
    ...
    "editor_inspect_material_instance_parameters": ToolSpec(
        tool_id="editor_inspect_material_instance_parameters",
        task_type="project_qa",
        title="Inspect Material Instance Parameters",
        description="Read Material Instance scalar, vector, texture, and static switch parameters from Project Inventory.",
        side_effect_level="read_only",
        route_preference="workflow",
        category="sensing",
        transport="http",
        ...
        permission_gate="read_only_whitelist",
        context_cost="low",
        trigger_keywords=("material parameters", "inspect material", "material instance parameters"),
        required_payload_fields=("material_instance_path",),
        optional_payload_fields=("project_id", "query", "parent_material", "limit"),
        input_schema={
            "type": "object",
            "properties": {
                "project_id": {"type": "string"},
    ...
    "editor_inspect_material_instance_detail": ToolSpec(
        tool_id="editor_inspect_material_instance_detail",
        task_type="project_qa",
        title="Inspect Material Instance Detail",
        description="Read one Material Instance detail record from Project Inventory by path, name, or query.",
        side_effect_level="read_only",
        route_preference="workflow",
        category="sensing",
        transport="http",
        ...
        permission_gate="read_only_whitelist",
        context_cost="low",
        trigger_keywords=("material detail", "inspect material instance", "material instance detail"),
        required_payload_fields=("material_instance_path",),
        optional_payload_fields=("project_id", "query"),
        input_schema={
            "type": "object",
    ...
    "editor_blueprint_add_step": ToolSpec(
        tool_id="editor_blueprint_add_step",
        task_type="editor_operation",
        title="Blueprint Add Step",
        description=(
            "MCP-style high-level alias for adding one whitelisted Blueprint step. "
            "The backend normalizes this into add_blueprint_node_template Proposal arguments."
        ),
        side_effect_level="confirmed_write",
        route_preference="proposal_wait",
        category="write",
        ...
        required_payload_fields=("blueprint_path", "step_name"),
        optional_payload_fields=(
            "graph_name",
            "template_id",
            "name",
    ...
    "editor_blueprint_set_edit_function": ToolSpec(
        tool_id="editor_blueprint_set_edit_function",
        task_type="editor_operation",
        title="Set Blueprint Edit Function Context",
        description=(
            "Plan-only MCP-style context tool. It selects the Blueprint graph/function that later "
            "Blueprint add/connect/compile Proposal tools should use as their default edit target."
        ),
        side_effect_level="plan_only",
        route_preference="workflow",
        category="context",
        ...
        trigger_keywords=(
            "set edit function",
            "set blueprint edit function",
            "select blueprint graph",
            "current blueprint graph",
            "设置蓝图编辑图表",
            "选择蓝图函数",
        ),
        required_payload_fields=("blueprint_path",),
        optional_payload_fields=("project_id", "graph_name", "function_name", "edit_function", "graph_type"),
        input_schema={
            "type": "object",
            "required": ["blueprint_path"],
            "properties": {
    ...
    "editor_blueprint_set_cursor_node": ToolSpec(
        tool_id="editor_blueprint_set_cursor_node",
        task_type="editor_operation",
        title="Set Blueprint Cursor Node Context",
        description=(
            "Plan-only MCP-style context tool. It selects a Blueprint node as the default cursor "
            "for later pin-connection or node-insertion Proposal tools."
        ),
        side_effect_level="plan_only",
        route_preference="workflow",
        category="context",
        ...
        trigger_keywords=(
            "set cursor node",
            "set blueprint cursor node",
            "select current blueprint node",
            "cursor blueprint node",
            "设置蓝图光标节点",
            "选择当前蓝图节点",
        ),
        required_payload_fields=("blueprint_path",),
    ...
    "mcp_get_editor_context": ToolSpec(
        tool_id="mcp_get_editor_context",
        task_type="editor_operation",
        title="Get Editor Context",
        description="Read lightweight live Unreal Editor status from the optional UEAgentTool TCP tool server.",
        side_effect_level="read_only",
        route_preference="single_tool",
        category="sensing",
        transport="mcp_tcp",
        mcp_tool_name="get_editor_context",
        requires_confirmation=False,
        active_context_keys=("project", "editor"),
        owned_by_skill="EditorSensingSkill",
        allowed_in_free_chat=True,
            ...
            "properties": {
                ...
                "structuredContent": {
                    ...
                    "properties": {
                        ...
                        "editor_world": {"type": "object"},
                    },
                },
            },
        },
    ),
    "mcp_get_selected_actors": ToolSpec(
        tool_id="mcp_get_selected_actors",
        task_type="editor_operation",
        title="Get Selected Actors",
        description="Read currently selected Level Actors from the optional UEAgentTool TCP tool server.",
        side_effect_level="read_only",
        route_preference="single_tool",
        category="sensing",
        transport="mcp_tcp",
        mcp_tool_name="get_selected_actors",
        requires_confirmation=False,
        active_context_keys=("project", "editor", "level_actor"),
        owned_by_skill="LevelActorAutomationSkill",
        allowed_in_free_chat=True,
        permission_gate="mcp_allowed_tools",
        context_cost="low",
        trigger_keywords=(
        ...
        output_schema={
            ...
            "properties": {
                ...
                "structuredContent": {
                    "type": "object",
                    "properties": {
                        "selection_schema_version": {"type": "string"},
                        "selected_actor_count": {"type": "integer"},
                        "actors": {"type": "array"},
                    },
                },
            },
    ...
    "mcp_get_level_actors": ToolSpec(
        tool_id="mcp_get_level_actors",
        task_type="editor_operation",
        title="Get Level Actors",
        description="Read current level Actors from the optional UEAgentTool TCP tool server with query, class, tag, folder, and limit filters.",
        side_effect_level="read_only",
        route_preference="single_tool",
        category="sensing",
        transport="mcp_tcp",
        mcp_tool_name="get_level_actors",
        requires_confirmation=False,
        active_context_keys=("project", "editor", "level_actor"),
        owned_by_skill="LevelActorAutomationSkill",
        allowed_in_free_chat=True,
        ...
        output_schema={
            ...
            "properties": {
                ...
                "structuredContent": {
                    "type": "object",
                    "properties": {
                        "level_actor_schema_version": {"type": "string"},
                        "world_name": {"type": "string"},
                        "map_name": {"type": "string"},
                        "total_actor_count": {"type": "integer"},
                        "matched_actor_count": {"type": "integer"},
                        "actors": {"type": "array"},
                        "filters": {"type": "object"},
                    },
                },
    ...
    "mcp_get_level_actor_details": ToolSpec(
        tool_id="mcp_get_level_actor_details",
        task_type="editor_operation",
        title="Get Level Actor Details",
        description="Read one current level Actor's live transform, tags, folder, class, and components from the optional UEAgentTool TCP tool server.",
        side_effect_level="read_only",
        route_preference="single_tool",
        category="sensing",
        transport="mcp_tcp",
        mcp_tool_name="get_level_actor_details",
        requires_confirmation=False,
        active_context_keys=("project", "editor", "level_actor"),
        owned_by_skill="LevelActorAutomationSkill",
        allowed_in_free_chat=True,
        ...
        required_payload_fields=("actor_reference",),
        optional_payload_fields=("query", "actor_label", "actor_name", "actor_path"),
        input_schema={
            "type": "object",
        ...
        output_schema={
            ...
            "properties": {
                ...
                "structuredContent": {
                    "type": "object",
                    "properties": {
                        "level_actor_detail_schema_version": {"type": "string"},
                        "world_name": {"type": "string"},
                        "map_name": {"type": "string"},
                        "actor_label": {"type": "string"},
                        "actor_name": {"type": "string"},
    ...
    "mcp_get_selected_assets": ToolSpec(
        tool_id="mcp_get_selected_assets",
        task_type="editor_operation",
        title="Get Selected Assets",
        description="Read currently selected Content Browser assets from the optional UEAgentTool TCP tool server.",
        side_effect_level="read_only",
        route_preference="single_tool",
        category="sensing",
        transport="mcp_tcp",
        mcp_tool_name="get_selected_assets",
        requires_confirmation=False,
        active_context_keys=("project", "editor", "asset"),
        owned_by_skill="AssetMaintenanceSkill",
        allowed_in_free_chat=True,
        permission_gate="mcp_allowed_tools",
        context_cost="low",
        trigger_keywords=(
    ...
    "mcp_get_static_mesh_details": ToolSpec(
        tool_id="mcp_get_static_mesh_details",
        task_type="editor_operation",
        title="Get Static Mesh Details",
        description="Read Static Mesh Nanite, LOD, collision, lightmap, and material slot details from the optional UEAgentTool TCP tool server.",
        side_effect_level="read_only",
        route_preference="single_tool",
        category="sensing",
        transport="mcp_tcp",
        mcp_tool_name="get_static_mesh_details",
        requires_confirmation=False,
        active_context_keys=("project", "editor", "asset"),
        owned_by_skill="AssetMaintenanceSkill",
        allowed_in_free_chat=True,
        ...
        output_schema={
            ...
            "properties": {
                ...
                "structuredContent": {
                    "type": "object",
                    "properties": {
                        "static_mesh_schema_version": {"type": "string"},
                        "static_mesh_name": {"type": "string"},
                        "static_mesh_path": {"type": "string"},
                        "static_mesh": {"type": "object"},
                    },
                },
            },
        },
    ...
    "editor_umg_set_widget_blueprint_context": ToolSpec(
        ...
        task_type="editor_operation",
        title="Set UMG Widget Blueprint Context",
        description=(
            "Plan-only MCP-style context tool. It selects the Widget Blueprint that later "
            "UMG add/set/reparent/duplicate/delete Proposal tools should use as their default target."
        ),
        side_effect_level="plan_only",
        route_preference="workflow",
        category="context",
        ...
        context_cost="low",
        trigger_keywords=(
            "set widget blueprint context",
            "set umg edit target",
            "select widget blueprint",
            "current widget blueprint",
            "select umg blueprint",
        ),
        required_payload_fields=("widget_blueprint_path",),
        optional_payload_fields=("project_id", "blueprint_path", "asset_path", "query", "root_widget_name"),
        input_schema={
            "type": "object",
    ...
    "editor_umg_set_cursor_widget": ToolSpec(
        tool_id="editor_umg_set_cursor_widget",
        task_type="editor_operation",
        title="Set UMG Cursor Widget Context",
        description=(
            "Plan-only MCP-style context tool. It selects one Widget Tree item as the default "
            "target or parent for later UMG Proposal tools."
        ),
        side_effect_level="plan_only",
        route_preference="workflow",
        category="context",
    ...
    "mcp_get_material_instance_parameters": ToolSpec(
        ...
        task_type="editor_operation",
        title="Get Material Instance Parameters",
        description=(
            "Read Material Instance parameters from the optional UEAgentTool TCP tool server. "
            "If no material_instance_path is provided, the frontend may use the currently selected "
            "Content Browser Material Instance."
        ),
        side_effect_level="read_only",
        route_preference="single_tool",
        category="sensing",
        transport="mcp_tcp",
        mcp_tool_name="get_material_instance_parameters",
        requires_confirmation=False,
        active_context_keys=("project", "asset", "material"),
        ...
        optional_payload_fields=("project_id", "material_instance_path", "asset_path", "query"),
        input_schema={
            "type": "object",
            "properties": {
                "project_id": {"type": "string"},
        ...
        output_schema={
            ...
            "properties": {
                ...
                "structuredContent": {
                    "type": "object",
                    "properties": {
                        "material_instance_schema_version": {"type": "string"},
                        "material_instance_path": {"type": "string"},
                        "material_instance_name": {"type": "string"},
                        "parent_material": {"type": "string"},
                        "parameter_count": {"type": "integer"},
                        "parameters": {"type": "array"},
                        "scalar_parameters": {"type": "array"},
                        "vector_parameters": {"type": "array"},
                        "texture_parameters": {"type": "array"},
                        "static_switch_parameters": {"type": "array"},
                    },
                },
            },
        },
    ...
    "editor_delete_umg_widget": ToolSpec(
        tool_id="editor_delete_umg_widget",
        task_type="editor_operation",
        title="Delete UMG Widget",
        description="Create a confirmed editor operation proposal to remove one existing non-root non-panel UMG widget.",
        side_effect_level="confirmed_write",
        route_preference="proposal_wait",
        category="write",
        transport="http",
        ...
        permission_gate="editor_operation_proposal",
        context_cost="medium",
        trigger_keywords=("delete umg widget", "remove widget", "delete widget"),
        required_payload_fields=("widget_blueprint_path", "widget_name"),
        optional_payload_fields=("reason", "source_task_id"),
        input_schema={
            "type": "object",
